...
function Card(props) {
    ...
    */
    ...
    return (
        <div className='card border-dark' style={type_card == "detail_card"? {width:"100%", borderStyle: "none"} : {width: "18rem", borderStyle: "solid", "&:hover":{boxShadow: "3px 5px 16px -3px black", backgroundColor: "gray"}}}>
